...
| Measure | Value |
| --- | --- |
| Out-of-fold macro F1 (6-fold) | **0.863** |
...
single 18-sample hold-out split of a 510-sample multi-domain dataset and moves by several
...
- **510 balanced multi-domain training samples (170 Human, 170 AI, 170 Hybrid with class_weight='balanced') (95 Human, 95 AI, 95 Hybrid with class_weight='balanced').** The corpus spans literature, history, philosophy, STEM, economics, psychology, and international student writing.
