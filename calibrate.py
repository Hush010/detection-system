...
Why this exists
---------------
`model.predict_proba` on a 72-sample TF-IDF + logistic-regression pipeline is
...
def calibrate() -> dict:
    ...
    # number that shows how unstable a 72-sample estimate really is.
    fold_f1 = [
        round(
    ...
    calibration = {
        ...
        "caveats": [
            "Calibrated on 72 short samples (median ~21 words). Treat every "
